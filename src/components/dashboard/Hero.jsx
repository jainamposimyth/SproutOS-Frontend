...
const Hero = () => {
  ...
  return (
  <div className="flex min-h-screen bg-sprout-color-background-default text-white">

  <div className="hidden md:flex fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-sprout-color-background-default ">
    <SideBar />
  </div>

  <div className="flex flex-col flex-1 min-h-screen md:ml-64">

    <header className="fixed top-0 left-0 right-0 z-50 bg-sprout-color-background-default">
      <Navbar />
    </header>
    <div className="fixed bottom-0  hidden md:block left-0 w-full h-4 rounded-t-md z-50 bg-sprout-color-background-dark"></div>
    <div className="fixed right-0 top-0 h-full hidden md:block w-4 rounded-l-md z-50 bg-sprout-color-background-dark ">
    ...
    <main className="flex-1 overflow-y-auto p-6 pt-52 md:pt-28 lg:pt-32">
          ...
          <div className="mt-6 sm:mt-8 md:mt-12 px-3 sm:px-6 lg:px-0">
            <div className="text-sprout-color-text-default font-semibold text-base sm:text-lg pt-6 sm:pt-8 md:pt-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6 md:gap-5">
