...
const StyleGuide = () => {
  return (
    <main className="bg-[#FFFDFA]  text-black flex-1 overflow-y-auto rounded-t-xl">
         <div className='h-full w-80 border p-6 overflow-x-auto '>
            ...
            <div className='flex flex-col pt-6 gap-6'>
              <Button className="bg-[#EFEFFF] cursor-pointer border border-[#695BE8] hover:bg-[#EFEFFF] text-[#695BE8]">
    ...
    <div>
       <div className='text-md font-[500] text-[#413735]'>
              Concepts
            </div>
            <Select>
              <SelectTrigger className="w-[270px] mt-4 border border-[#D7D3C9] ">
          ...
          <div className='text-md font-[500] text-[#413735]'>
            ...
            <div className='border rounded-md mt-4 border-[#D7D3C9] w-68 h-80'>

            </div>
             <Button className="bg-[#EFEFFF] cursor-pointer border w-full mt-4 border-[#695BE8] hover:bg-[#EFEFFF] text-[#695BE8]">
...
Add Colors
          ...
          <div className='text-md font-[500] text-[#413735]'>
              ...
              <div className='border rounded-md mt-4 border-[#D7D3C9] w-68 h-52'>
